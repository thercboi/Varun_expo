  ...
  export default function MyDrawer() {
    return (
      ...
      >
        ...
        <Drawer.Screen name="Signup" component={SignUp} options={{headerTitle:"Varun Finance"}} />
        <Drawer.Screen name="Login" component={Login} options={{headerTitle:"Login Form"}} />
        <Drawer.Screen name="Customer Details" component={CustomerDetails} options={{headerTitle:"Varun Finance Customer Details"}} />
